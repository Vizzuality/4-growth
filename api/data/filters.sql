...
-- INSERT INTO public.page_filters VALUES ('yes/no', 'Yes;No');
...
-- INSERT INTO public.page_filters VALUES ('yes/no/don''t-know', 'Yes;No;Don''t know');
-- Includes answer-{1,2,3,4} INSERT INTO public.page_filters VALUES ('answer', 'Facilitated;Completely;Hindered;Partially;No impact;Not at all;Advancements in existing technologies;<25%;Emergence of new technologies;<50%;No significant changes anticipated;<75%;>90%');
